...
const TechnologyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="text-center bg-gradient-ai backdrop-blur-sm border border-primary/20 rounded-xl p-4"
                >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {techStack.map((stack, index) => (
              <Card
                key={index}
                className="p-6 hover:shadow-ai transition-all duration-300"
              >
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="bg-gradient-to-br from-[#40316a]/90 to-[#3f3364]/70 text-white rounded-3xl p-16 text-center max-w-4xl mx-auto">
