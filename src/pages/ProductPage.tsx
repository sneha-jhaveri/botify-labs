  ...
  const techSpecs = [
    {
      ...
      description:
        "Task-specific AI models that run 10x faster and cost 90% less than GPT-4",
    ...
    },
    {
      ...
      description:
        "Deploy in 100+ countries with local compliance and data residency",
    ...
    },
    {
      ...
      description:
        "Orchestrate teams of AI agents that work together seamlessly",
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              From simple chatbots to complex multi-agent workflows. Build,
              deploy, and scale your AI employees with enterprise-grade tools
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Real drag-and-drop interface - no signup required
              </p>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            <p className="text-xl text-muted-foreground">
              Six powerful modules working together to automate your entire
              business workflow
            </p>
          </div>
                ...
                <div className={`${index % 2 === 1 ? "lg:order-1" : ""}`}>
                  <div className="bg-gradient-ai backdrop-blur-sm border border-primary/20 rounded-2xl p-6 shadow-glow">
                    <div className="h-[400px] lg:h-[500px] overflow-hidden rounded-xl">
                      ...
                      {feature.demo === "builder" && <InteractiveAIBuilder />}

                      {feature.demo === "analytics" && (
                        <InteractiveAnalyticsDashboard />
                      )}

                      {feature.demo === "crm" && <InteractiveCRM />}

                      {feature.demo === "social" && <InteractiveSocialMedia />}
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 bg-gradient-to-b from-muted/20 to-background">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Industry-leading performance, security, and reliability that
              enterprises trust
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {techSpecs.map((spec, index) => (
              <div
                key={index}
                className="bg-gradient-ai backdrop-blur-sm border border-primary/20 rounded-xl p-6 text-center group hover:shadow-glow transition-all duration-300"
              >
        ...
        <div className="container mx-auto px-6">
          <div className="bg-gradient-to-br from-[#40316a]/90 to-[#3f3364]/70 text-white rounded-3xl p-8 lg:p-16 text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              Join thousands of companies already using BotWot AI to automate
              their workflows and scale their operations with intelligent AI
              employees.
            </p>
