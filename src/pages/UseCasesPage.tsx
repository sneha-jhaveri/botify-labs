...
const UseCasesPage = () => {
  ...
  const currentUseCase =
    useCases.find((uc) => uc.id === activeUseCase) || useCases[0];
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              Discover how leading companies across industries are using BotWot
              AI to automate complex workflows and deliver exceptional customer
              experiences.
            </p>
              ...
              <div className="bg-gradient-ai backdrop-blur-sm border border-primary/20 rounded-3xl p-8">
                ...
                <div className="flex items-start justify-between mb-8">
                  <div className="flex items-center space-x-4">
                    <div
                      className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${currentUseCase.color} flex items-center justify-center`}
                    >
                  ...
                  <Badge
                    className={`${currentUseCase.bgColor} ${currentUseCase.textColor} border-none`}
                  >
                    Live Solutions
                  </Badge>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                  {Object.entries(currentUseCase.metrics).map(
                    ([key, value]) => (
                      <div
                        key={key}
                        className="bg-background/50 rounded-xl p-4 text-center border border-border/30"
                      >
                        <div
                          className={`text-xl font-bold ${currentUseCase.textColor} mb-1`}
                        >
                          {value}
                        </div>
                        <div className="text-xs text-muted-foreground">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {currentUseCase.features.map((feature, index) => (
                        ...
                        >
                          <CheckCircle2
                            className={`w-4 h-4 ${currentUseCase.textColor}`}
                          />
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {currentUseCase.workflows.map((workflow, index) => (
                        <div
                          key={index}
                          className="text-sm bg-background/30 rounded-lg p-3 border border-border/20"
                        >
                          {workflow}
                        </div>
                      ))}
            ...
            <div className="flex items-center justify-between p-6 border-b border-border/30">
              <div>
                ...
                <p className="text-muted-foreground">
                  Drag and connect AI blocks to create intelligent automation
                </p>
              </div>
              <Button
                variant="ghost"
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Real results from companies that transformed their operations with
              BotWot AI
            </p>
          </div>
            ...
            {[
              {
                ...
                quote:
                  "BotWot AI revolutionized our customer onboarding. What used to take days now happens in minutes.",
                metrics: [
                  "70% cost reduction",
                  "94% satisfaction",
                  "99.2% accuracy",
              ...
              },
              {
                ...
                quote:
                  "Our AI agents handle 80% of inquiries automatically, letting our team focus on closing deals.",
                metrics: [
                  "65% conversion rate",
                  "<2min response",
                  "92% satisfaction",
              ...
              },
              {
                ...
                quote:
                  "The personalized shopping assistant increased our sales by 35% in just 3 months.",
                metrics: [
                  "35% sales growth",
                  "80% fewer tickets",
                  "68% retention",
              ...
              <div
                key={index}
                className="bg-gradient-ai backdrop-blur-sm border border-primary/20 rounded-xl p-6"
              >
                <div className="mb-6">
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="bg-gradient-to-br from-[#40316a]/90 to-[#3f3364]/70 text-white rounded-3xl p-8 lg:p-16 text-center max-w-4xl mx-auto">
            <h2 className="text-3xl lg:text-5xl font-bold mb-6">
              Ready to Transform Your Industry?
            </h2>
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              Join hundreds of companies already using BotWot AI to automate
              workflows and deliver exceptional experiences in their industry.
            </p>
