...
const DemosPage = () => {
  ...
  const industryShowcases = [
    ...
    },
    {
      ...
      title: "Real Estate",
      description:
        "Lead qualification, property matching, and viewing coordination",
    ...
    },
    {
      ...
      title: "E-commerce",
      description:
        "Product recommendations, cart recovery, and order management",
    ...
    },
    {
      ...
      description:
        "Booking automation, schedule changes, and travel assistance",
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              Experience our AI employees live. Try real conversations, build
              workflows, and see how BotWot AI transforms business operations
              across industries.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                variant="cta"
                size="xl"
                onClick={() => setActiveDemo("banking-chat")}
              >
                Try Live Demo
              </Button>
                  ...
                  <div className="bg-gradient-ai backdrop-blur-sm border border-primary/20 rounded-3xl p-8">
                    <div className="text-center mb-8">
                      ...
                      <p className="text-muted-foreground">
                        Drag, drop, and connect AI blocks to create powerful
                        automation
                      </p>
                    </div>
                    <WorkflowBuilder
                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div>
                          <h3 className="text-2xl font-bold mb-2">
                            {
                              category.demos.find((d) => d.id === activeDemo)
                                ?.title
                            }{" "}
                            Demo
                          </h3>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Watch how AI intelligently orchestrates customer journeys across
              different industries, making real-time decisions based on customer
              intent and behavior
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-b from-muted/20 to-background">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how leading companies in each industry are using BotWot AI to
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {industryShowcases.map((showcase, index) => (
              <div
                key={index}
                className="bg-gradient-ai backdrop-blur-sm border border-primary/20 rounded-xl overflow-hidden group hover:shadow-glow transition-all duration-300"
              >
                {/* Header */}
        ...
        <div className="container mx-auto px-6">
          <div className="bg-gradient-to-br from-[#40316a]/90 to-[#3f3364]/70 text-white rounded-3xl p-8 lg:p-16 text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              You've seen what's possible. Now create your own AI employees and
